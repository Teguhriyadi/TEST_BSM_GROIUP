...
class MasterDokumenUpdateRequest extends FormRequest
{
    ...
    {
        $id = $this->route('masterDokumen') ?? $this->route('master_dokumen') ?? null;
        return [
            'kode_dokumen' => 'required|string|max:50|unique:master_dokumen,kode_dokumen,' . $id,
