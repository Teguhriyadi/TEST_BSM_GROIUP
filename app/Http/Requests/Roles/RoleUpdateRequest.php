...
class RoleUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'kode_role' => 'required|string|max:50|unique:role,kode_role,' . $roleId,
    ...
    public function messages(): array
    {
        return [
            ...
            'permissions.array' => 'Format pilihan Permission tidak valid.',
            'permissions.*.uuid' => 'Format Permission yang dipilih tidak valid.',
