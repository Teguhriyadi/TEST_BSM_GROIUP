...
<head>
    ...
    <title>Lupa Password - Sistem Koperasi Simpan Pinjam</title>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-7 form-section">
                            <div class="mb-4">
                                ...
                                <p class="text-muted text-sm">Masukkan email terdaftar Anda. Kami akan mengirimkan link untuk mereset password melalui email.</p>
                            </div>
                            ...
                            <form action="{{ route('password.email') }}" method="POST">
                                ...
                                <div class="mb-4">
                                    <label for="email"
                                        class="form-label fw-semibold text-secondary small">Email Terdaftar</label>
                                ...
                                <div class="d-grid mb-3">
                                    <button type="submit" class="btn btn-orange btn-lg shadow-sm">Kirim Link Reset Password</button>
                                </div>
