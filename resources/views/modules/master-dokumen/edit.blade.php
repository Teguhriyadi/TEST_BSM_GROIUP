...
@push('title')
    Ubah Master Dokumen | BSM Koperasi
@endpush
...
@push('breadcrumbs')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5 small">
            ...
            <li class="breadcrumb-item text-sm text-dark"><a class="opacity-5 text-dark"
                    href="{{ route('master-dokumen.index') }}">Master Dokumen</a></li>
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" maxlength="50" class="form-control" name="kode_dokumen"
                            value="{{ old('kode_dokumen', $masterDokumen->kode_dokumen) }}">
                    </div>
                    <div class="col-md-8">
                        <label class="form-label fw-medium small">Nama Dokumen <span class="text-danger">*</span></label>
                        <input type="text" maxlength="150" class="form-control" name="nama_dokumen"
                            value="{{ old('nama_dokumen', $masterDokumen->nama_dokumen) }}">
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="format_diperbolehkan"
                            value="{{ old('format_diperbolehkan', $masterDokumen->format_diperbolehkan ?? 'jpg,jpeg,png,pdf') }}">
                        <div class="form-text small text-muted">Dipisah koma. Contoh: jpg,jpeg,png,pdf</div>
                    </div>
                    <div class="col-md-6 d-flex align-items-end">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1"
                                @checked(old('is_active', $masterDokumen->is_active ? '1' : '0') === '1')>
