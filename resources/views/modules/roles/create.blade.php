    ...
    <div class="col-lg-10">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary">Tambah Role & Permission</h6>
                ...
                <form method="POST" action="{{ route('roles.store') }}">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('kode_role') is-invalid @enderror" id="kode_role" name="kode_role" value="{{ old('kode_role') }}" placeholder="Contoh: ROL-AUD">
                            @error('kode_role')
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_role') is-invalid @enderror" id="nama_role" name="nama_role" value="{{ old('nama_role') }}" placeholder="Contoh: Auditor Internal">
                            @error('nama_role')
                            <div class="invalid-feedback"><small>{{ $message }}</small></div>
                            @enderror
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-6 mb-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="permissions[]" id="perm_{{ $p->id }}" value="{{ $p->id }}" {{ is_array(old('permissions')) && in_array($p->id, old('permissions')) ? 'checked' : '' }}>
