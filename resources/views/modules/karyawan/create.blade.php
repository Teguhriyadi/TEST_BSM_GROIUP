            ...
            <div class="card-body">
                <form method="POST" action="{{ route('karyawan.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ old('nama') }}" maxlength="100" placeholder="Masukkan nama lengkap karyawan">
                        @error('nama')
                        <div class="invalid-feedback">
                            <small>{{ $message }}</small>
                        </div>
                    ...
                    <div class="mb-3">
                        <label for="email" class="form-label">Email (untuk Akun Login Karyawan)<span class="text-danger">*</span></label>
                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" maxlength="100" placeholder="Email karyawan, jika diisi maka akan otomatis dibuatkan akun login">
