                    ...
                    <table class="table table-striped table-bordered table-hover align-middle datatable" width="100%" cellspacing="0">
                        <thead class="bg-primary text-white">
                            <tr>
                                ...
                                <th>Nomor HP</th>
                                <th>Status</th>
                                @hasanypermission(['USERS_VIEW','USERS_UPDATE','USERS_DELETE'])
                                <th>Aksi</th>
                                @endhasanypermission
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->email }}</td>
                                <td>
                                    <span class="badge bg-orange text-white">{{ $item->role->nama_role ?? '-' }}</span>
                                </td>
                                ...
                                <td>
                                    ...
                                    <form class="d-inline form-delete" method="POST" action="{{ route('users.destroy', $item->id) }}">
                                        @csrf
                                        @method('DELETE')
